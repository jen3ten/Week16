...
namespace Week16_KLGradebookExample_04272016.Controllers
{
    public class AssignmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AssignmentID,Title,PointsAvailable")] Assignment assignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AssignmentID,Title,PointsAvailable")] Assignment assignment)
        {
            if (ModelState.IsValid)
            {
